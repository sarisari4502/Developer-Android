...
import static id.ac.poliban.mi.sari.roomwordssample.MainActivity.UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.sari.roomwordssample.REPLY";
    public static final String EXTRA_WORD_ID = "id.ac.poliban.mi.sari.roomwordssample.REPLY_ID";
